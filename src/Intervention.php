    ...
    <BODY>
        <table style="border: 1px;">
            <tr>
                ...
                <th>Modified Image after
                    <?php echo $_POST["optionImage"] . " with grade " . $_POST["grade"] ?>
                </th>
            </tr>
            <tr>
                <td>
...
try {
    switch ($_POST["optionImage"]) {
        case "blur":
            // $image0bject->blur($_POST["grade"]); fix defect 3
        ...
        case "sharpen":
            ...
            break;
        case "gamma": // new functionality
            $imageObject->gamma($_POST["grade"]);
            break;
    }

} catch (Throwable $e) {
    // echo "error in bright option"; fix defect 3
    echo "error in" . $_POST["optionImage"];
}
